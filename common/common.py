...
def createParser ():
    ...
    parser.add_argument ('-ip', '--ip', default='192.168.5.55')
    parser.add_argument ('-port', '--port', default='2032')
   
    parser.add_argument ('-sql_host', '--sql_host', default='192.168.5.60')
    parser.add_argument ('-sql_base', '--sql_base', default='aa')
    parser.add_argument ('-sql_user', '--sql_user', default='sa')
    parser.add_argument ('-sql_pass', '--sql_pass', default='20SenseY13*')

    parser.add_argument ('-ones_user', '--ones_user', default='administrator')
    parser.add_argument ('-ones_pass', '--ones_pass', default='123123123')
    parser.add_argument ('-ones_host', '--ones_host', default='192.168.5.60')
    parser.add_argument ('-ones_ws',   '--ones_ws',   default="http://192.168.5.60/aa/ws/gate.1cws?wsdl&x=1")
